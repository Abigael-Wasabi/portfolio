  ...
  return (
    <>
      <Row style={{textAlign: 'center', display: 'flex', alignItems: 'center',justifyContent: 'center'}}>
          <b>MY BLUEPRINTS</b>
          <li><a target='_blank' href="https://coolkicks-sneaker-lhx1b92l6-abigael-wasabis-projects.vercel.app/" rel="noreferrer">(COOL KICKS)sneaker shop</a></li><br></br>
          <li><a target='_blank' href="https://swiftpark-u-imain.vercel.app/" rel="noreferrer">VEHICLE PARKING MANAGEMENT SYSTEM</a></li><br></br>
          <li><a href="whta">WHTA NETWORKS WEBSITE</a><text></text></li>
