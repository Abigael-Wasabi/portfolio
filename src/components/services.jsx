...
// function Services() {
//     let imgsrc;imgsrc=require('../assets/webdev.jpg');
//     let srcimg;srcimg=require('../assets/andrdev.png');
//     let imgs;imgs=require('../assets/designweb.png');
//   return (
...
//           <text className="text-gray-700 text-center">I specialize in crafting dynamic and responsive websites 
...
//           <text className="text-gray-700 text-center">I focus 
...
//           </div>
//           <h2 className="text-xl font-bold text-center mb-2">ANDROID DEVELOPMENT</h2>
//           <text className="text-gray-700 text-center">Transform your ideas into powerful Android applications 
